 ...
 * @Date: 2021-03-06 11:44:09 
 * @Last Modified by: guanlanluditie
 * @Last Modified time: 2021-03-06 12:06:14
 */

export const setWalletDetialEn = {
    'Wallet management': 'Wallet Management',
    'Wallet address': 'Wallet Address',
    'Wallet name': 'Wallet Name',
    'Wallet password': 'Wallet Password',
    'Wallet backup': 'Backup Wallet',
    'Backup keystore': 'Export Keystore',
    'delete': 'Remove',
    ...
    'usedName': 'The name has been used',
}
...
export const setWalletDetialZh = {
    ...
    'delete': '删除',
    'Name updated': '名称已更新',
    'Change wallet name': '修改钱包名称',
    '1-12 characters': '1-12个字符',
    'confirm': '确认',
    'Wrong password': '密码错误',
    'Account deleted': '已删除账号',
    'Delete Wallet': '删除钱包',
    ...
    'The number of password digits is less than 8': '密码位数少于8位',
